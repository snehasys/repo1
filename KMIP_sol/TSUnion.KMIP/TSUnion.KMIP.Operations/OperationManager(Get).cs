...
namespace TSUnion.KMIP.Operations
{
    public partial class OperationManager
    {
        ...
        private ResponseMessage Get(RequestMessage requestMessage, ref ResponseMessage responseMessage)
        {
            ...
            responseMessage.BatchItem.ResponsePayload.Attribute.Items.Add(Constants.CRYPTO_OBJECT, existedManagedObject);
