...
namespace TSUnion.KMIP.Operations
{
    public partial class OperationManager
    {
        ...
        private ResponseMessage GetAttributeList(RequestMessage requestMessage, ref ResponseMessage responseMessage)
        {
            ...
            if (existedManagedObject == null)
            {
                ...
                string attribsNames = existedManagedObject.GetAttributeList();
                responseMessage.BatchItem.ResponsePayload.Attribute.Items.Add("AttributeList", attribsNames);
