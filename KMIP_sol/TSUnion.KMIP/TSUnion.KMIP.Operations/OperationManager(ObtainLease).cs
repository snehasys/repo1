...
namespace TSUnion.KMIP.Operations
{
    public partial class OperationManager
    {
        ...
        private ResponseMessage ObtainLease(RequestMessage requestMessage, ref ResponseMessage responseMessage)
        {
            ...
            responseMessage.BatchItem.ResponsePayload.Attribute.Items.Add("LeaseTime", existedManagedObject.GetLeaseTimeInSeconds());
